...
    })(window,document,'script','dataLayer','GTM-PQ8Z5BBX');
  </script>
    <meta charset="UTF-8" />
...
<body>
    <noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PQ8Z5BBX"
...
        e.preventDefault();
        // O dataLayer já existe pela inicialização do GTM, então não precisa do || []
